...
NOTE: This document and the XML schema were officially approved as MML version 4 standard on the board, but they are still in the development phase, updates are inevitable.
