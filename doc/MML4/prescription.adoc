...
システムが1回量に対応しておらず1日量しかデータが得られない場合には、やむを得ずdoseに1日量を記載し、frequencyPerDayを1回と記録して一日の投与量がわかるようにし、指示に「毎食後三分割」と記載する。
...
|mmlPs:system|string|不可| |用いたコード体系の名称を記載
|===
